...
function b2() {
    ...
    b2.prototype.draw = function (context) {
    ...
    b2.prototype.setVector = function(vector)
    {
    ...
    b2.prototype.accelerate = function (Acceleration) {
        //set vx
        vx += Acceleration.AX;
        //set vy
        vy += Acceleration.AY;
