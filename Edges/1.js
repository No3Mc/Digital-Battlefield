...
function b1() {
    ...
    b1.prototype.draw = function (context) {
    ...
    b1.prototype.setVector = function(vector)
    {
    ...
    b1.prototype.accelerate = function (Acceleration) {
        //set vx
        vx += Acceleration.AX;
        //set vy
        vy += Acceleration.AY;
