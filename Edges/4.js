...
function b4() {
    ...
    b4.prototype.draw = function (context) {
    ...
    b4.prototype.setVector = function(vector)
    {
    ...
    b4.prototype.accelerate = function (Acceleration) {
        //set vx
        vx += Acceleration.AX;
        //set vy
        vy += Acceleration.AY;
